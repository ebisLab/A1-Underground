			...
			{ cart ? (
				<div className="container-cart woo-next-cart-wrapper container">
					...
					<div className="grid-cont grid grid-cols-1 xl:grid-cols-4 gap-0 xl:gap-4 mb-5">
						<table className="tblcart cart-products table-auto col-span-3 mb-5">
						...
						{/*Cart Total*/ }
						<div className="cart-total-container row woo-next-cart-total-container border p-5 bg-gray-200">
							<div className="">
